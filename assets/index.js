...
// Storing data in Local Storage using ("setItem()") method............................
localStorage.setItem(storeScore, "null");
localStorage.setItem(storeScore, "null");

// IIFE(Immediately Invoked Function Expression)...............
(function () {
  // Getting Data from the Local Storage using ("getItem()") method.........................
...
document.addEventListener("keydown", function (event) {
  if (event.keyCode === 68 || event.keyCode === 39) {
    if (
      ...
      bar1.style.left = parseFloat(bar1.style.left) + movement + "px";
      bar2.style.left = bar1.style.left;
    }
  }

  if (event.keyCode === 65 || event.keyCode === 37) {
    if (parseFloat(bar1.style.left) > border) {
      bar1.style.left = parseFloat(bar1.style.left) - movement + "px";
      bar2.style.left = bar1.style.left;
    }
  }
...
// Data Storing Function of the Game.................................
function dataStoring(scoreObtained, winningBar) {
  if (score > highScore) {
    highScore = score;

    // Replacing Data in Local Storage using ("setItem()") method...............
  ...
  // Show alert message when one of the player win...................
  alert(
    winningBar +
      " wins with score of " +
      scoreObtained * 100 +
